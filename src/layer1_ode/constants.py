"""
constants.py
Constantes físicas y parámetros gravitacionales.
...
# Tolerancias globales del integrador (consistente con JPL)
RTOL = 1e-9
ATOL = 1e-12
MAX_STEP_DAYS = 5.0  # Evita saltar encuentros cercanos o periapsis