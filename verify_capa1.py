"""verify_capa1.py → Diagnóstico completo de conexión, física y rendimiento."""
import numpy as np
...
def main():
    ...
    earth_res = propagate("399", "2024-01-01", t_years=5.0)
    earth_res["earth_pos"] = earth_res.pop("asteroid_pos")
